const toPoints = ({ type, ...props }, isSimple=false) => {
  switch (type) {
    case 'circle':
    ...
    case 'path':
      return isSimple ? getPointsFromPathSimple(props) : getPointsFromPath(props);
    case 'polygon':
...
const getPointsFromPathSimple = ({ d }) => {
      ...
      for (let j = 0; j < iterations; j++) {
        ...
        switch (upperCaseCommand) {
          ...
          case 'L':
            ...
            // })
            points.push([
              (relative ? prevPoint.x : 0) + commandParams.shift(),
              (relative ? prevPoint.y : 0) + commandParams.shift()
            ]);
          ...
          case 'Q':
            ...
            //   y: (relative ? prevPoint.y : 0) + commandParams.shift()
            // })
            points.push([(relative ? prevPoint.x : 0) + commandParams.shift(),
               (relative ? prevPoint.y : 0) + commandParams.shift()]);
